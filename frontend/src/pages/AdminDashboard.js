    ...
    <>
      ...
      >
        <div className="container text-center">
          <h1 className="display-4 fw-bold">Donate Blood, Save Lives</h1>
      ...
      <section className="about-section">
        <div className="about-wrap">
          ...
          <p>
            ...
            recipients, hospitals, and blood banks in one reliable network. Our
            goal is to make blood availability fast, transparent, and easy to
        ...
        <div className="features-wrap">
          ...
          <div className="features-grid">
            ...
            <div className="feature-card">
              ...
              <Link to="/appointments-list" className="feature-btn">
                Explore
              </Link>
            </div>
            <div className="feature-card">
      ...
      <section className="contact-message-section">
        <div className="contact-message-wrap">
          ...
          <p>
            If you have queries, support requests, or collaboration ideas, please
            write to us at:
          </p>
